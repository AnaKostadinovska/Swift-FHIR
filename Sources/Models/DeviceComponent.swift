...
open class DeviceComponent: DomainResource {
    ...
    //ana added this
    public var property: [PropertyDeviceComponent]?
    ...
    override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
        ...
        //ana added this
        property = createInstances(of: PropertyDeviceComponent.self, for: "property", in: json, context: &instCtx, owner: self) ?? property
...
//ana added this
open class PropertyDeviceComponent: BackboneElement {
    
    override open class var resourceType: String {
        get { return "PropertyDeviceComponent" }
    }
